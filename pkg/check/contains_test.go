...
func TestContains(t *testing.T) {
	...
	for _, v := range s {
		if check.Contains(v.str, v.substr) != v.expected {
...
func TestContainsAny(t *testing.T) {
	...
	for _, v := range s {
		if check.ContainsAny(v.str, v.substr) != v.expected {
...
func TestContainsRune(t *testing.T) {
	...
	for _, v := range s {
		if check.ContainsRune(v.str, v.r) != v.expected {
...
func TestContainsSpace(t *testing.T) {
	...
	for _, v := range s {
		if check.ContainsSpace(v.str) != v.expected {
...
func TestContainsOnly(t *testing.T) {
	...
	for _, v := range s {
		if check.ContainsOnly(v.str, v.substr) != v.expected {
...
func TestContainsNone(t *testing.T) {
	...
	for _, v := range s {
		if check.ContainsNone(v.str, v.substr) != v.expected {
