...
func TestToLower(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.ToLower(v.in); out != v.out {
...
func TestToLowerFirst(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.ToLowerFirst(v.in); out != v.out {
...
func TestToUpper(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.ToUpper(v.in); out != v.out {
...
func TestToUpperFirst(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.ToUpperFirst(v.in); out != v.out {
...
func TestTitle(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.Title(v.in); out != v.out {
...
func TestToTitle(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.ToTitle(v.in); out != v.out {
...
func TestCamel(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.Camel(v.in); out != v.out {
...
func TestUnCamel(t *testing.T) {
	...
	for _, v := range s {
		if out := convert.UnCamel(v.in, "_"); out != v.out {
